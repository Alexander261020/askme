class UsersController < ApplicationController
  ...
  def show
    ...
    @questions = [
      ...
      Question.new(text: 'It is number 2', created_at: Date.parse('27.03.2016')),
      Question.new(text: 'It is number 3', created_at: Date.parse('27.03.2016')),
      Question.new(text: 'It is number 4', created_at: Date.parse('27.03.2016')),
      Question.new(text: 'It is number 5', created_at: Date.parse('27.03.2016')),
